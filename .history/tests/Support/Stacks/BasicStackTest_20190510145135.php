...
namespace Sormagec\RoadRunnerLaravel\Tests\Support\Stacks;

use Illuminate\Contracts\Support\Arrayable;
use Sormagec\RoadRunnerLaravel\Tests\AbstractTestCase;
use Sormagec\RoadRunnerLaravel\Support\Stacks\AbstractStack;
use Sormagec\RoadRunnerLaravel\Support\Stacks\StackInterface;
...
class BasicStackTest extends AbstractTestCase
{
    ...
    public function testMakeMethod()
    {
        $this->assertEquals(
            ...
            $this->instance::make() // Test without arguments passing
        );
    }
