...
class Worker implements WorkerInterface
{
     ...
     */
    protected function createCallbacksInitializer(
        StartOptionsInterface $start_options,
        CallbacksInterface $callback_stacks
    ): CallbacksInitializerInterface {
